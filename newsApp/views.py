...
def update_profile(request):
    ...
    if not request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect("newsapp:profile-page")
        else:
            context['form'] = form
            
    return render(request, 'news/update_profile.html',context)
...
def update_password(request):
    ...
    if request.method == 'POST':
        ...
        context['form'] = form
    return render(request,'news/update_password.html',context)
...
def manage_post(request, pk = None):
    ...
    return render(request, 'news/manage_post.html',context)
...
def category_posts(request,pk=None):
    ...
    if pk is None:
        ...
        return redirect('newsapp:home-page')
    try:
