...
class ParentProfile(forms.ModelForm):
    ...
    occupation = forms.ChoiceField(label='Occupation' ,choices=occupation_categories )
    ...
    class Meta():
        model = Parent
        fields = ['prof_image','father_name', 'mother_name','occupation','dob', 'blood_group','mobile','gender',]
        widgets = {
