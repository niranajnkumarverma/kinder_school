    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prof_image', models.FileField(default='', upload_to='teacher/profile_img/')),
                ('father_name', models.CharField(default='', max_length=100)),
                ('mother_name', models.CharField(default='', max_length=100)),
                ('classe', models.CharField(choices=[('Select Class', 'Select class'), ('Play', 'Play'), ('Nursery', 'Nursery'), ('One', 'One'), ('Two', 'Two'), ('Three', 'Three'), ('Four', 'Four'), ('Five', 'Five'), ('Six', 'Six'), ('Seven', 'Seven'), ('Eight', 'Eight'), ('Nine', 'Nine'), ('Tenth', 'Tenth'), ('Eleven', 'Eleven')], default='Nursery', max_length=10)),
                ('section', models.CharField(choices=[('None', 'Select Section'), ('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E'), ('F', 'F')], default='A', max_length=20)),
                ...
                ('religion', models.CharField(choices=[('Select Religion', 'Select religion'), ('Hindu', 'Hindu'), ('Islam', 'Islam'), ('Christian', 'Christian'), ('Buddish', 'Buddish'), ('Others', 'Others')], default='hindu', max_length=15)),
