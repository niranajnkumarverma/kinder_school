...
from .models import Code, Student, User,State,City,Country
...
class StudentProfileForm(forms.ModelForm):
    ...
    father_occupation = forms.ChoiceField(label='Father Occupation' ,choices=father_occupation_categories )
    blood_group = forms.ChoiceField(label='Blood Group',choices=blood_group_choice)
 
    # religion = forms.ChoiceField(choices=religion_categories)
    ...
    role = forms.CharField(label='Role', required=True, widget=forms.TextInput(
        attrs={
            'class': 'form-control',
    ...
    class Meta:
        model = Student
        fields = ['prof_image','father_name', 'mother_name' ,'father_occupation', 'blood_group', 'religion','classe', 'section', 'role','dob','mobile','gender','address','country','state','city','pincode']
        widgets = {
...
class MobileOTPForm(forms.ModelForm):
    number = forms.CharField(label='Verify mobile otp ', help_text='Enter Sms Verifications')
...
class UserPasswordResetForm(PasswordResetForm):
    ...
    def clean(self):
       ...
       if not User.objects.filter(email=email).exists():
           raise ValidationError("This email address is not valid account? Please register.")
