    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prof_image', models.FileField(default='', upload_to='student/profile_img/')),
                ...
                ('classe', models.CharField(choices=[('Select Class', 'Select class'), ('Play', 'Play'), ('Nursery', 'Nursery'), ('One', 'One'), ('Two', 'Two'), ('Three', 'Three'), ('Four', 'Four'), ('Five', 'Five'), ('Six', 'Six'), ('Seven', 'Seven'), ('Eight', 'Eight'), ('Nine', 'Nine'), ('Tenth', 'Tenth'), ('Eleven', 'Eleven')], default='', max_length=10)),
                ('section', models.CharField(choices=[('None', 'Select Section'), ('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E'), ('F', 'F')], default='', max_length=20)),
